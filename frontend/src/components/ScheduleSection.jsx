...
const ScheduleSection = () => {
  ...
  const scheduleData = {
    day1: [
      { time: "8:00 AM", title: "Registration & Networking Breakfast", speaker: "", type: "networking", description: "Welcome coffee and networking session" },
      { time: "9:00 AM", title: "Opening Keynote: The Future of Banking", speaker: "Sarah Johnson", type: "keynote", description: "Setting the stage for digital transformation in financial services" },
      { time: "10:00 AM", title: "Panel: AI Revolution in Financial Services", speaker: "Dr. Emily Rodriguez, Michael Chen, Lisa Park", type: "panel", description: "Exploring AI applications, challenges, and opportunities" },
      { time: "11:15 AM", title: "Coffee Break & Exhibition", speaker: "", type: "break", description: "Networking and sponsor exhibitions" },
      { time: "11:45 AM", title: "Blockchain and Digital Assets", speaker: "Michael Chen", type: "presentation", description: "The role of blockchain in modern banking infrastructure" },
      { time: "12:30 PM", title: "Lunch & Networking", speaker: "", type: "networking", description: "Networking lunch with industry peers" },
      { time: "2:00 PM", title: "Customer Experience Transformation", speaker: "Amanda Foster", type: "presentation", description: "Designing exceptional digital customer journeys" },
      { time: "2:45 PM", title: "Cybersecurity in Digital Banking", speaker: "David Thompson", type: "presentation", description: "Protecting digital assets and customer data" },
      { time: "3:30 PM", title: "Afternoon Break", speaker: "", type: "break", description: "Refreshments and networking" },
      { time: "4:00 PM", title: "Innovation Showcase", speaker: "Multiple Presenters", type: "showcase", description: "Latest fintech innovations and startup pitches" },
      { time: "5:00 PM", title: "Day 1 Wrap-up & Cocktail Reception", speaker: "", type: "networking", description: "End of day networking with drinks" }
    ],
    day2: [
      { time: "9:00 AM", title: "Day 2 Opening: Sustainable Finance", speaker: "Maria Gonzalez", type: "keynote", description: "ESG integration and sustainable banking practices" },
      { time: "10:00 AM", title: "Data Analytics & Insights", speaker: "Robert Kumar", type: "presentation", description: "Leveraging big data for business intelligence" },
      { time: "10:45 AM", title: "Regulatory Technology (RegTech)", speaker: "James Wilson", type: "presentation", description: "Automating compliance and regulatory processes" },
      { time: "11:30 AM", title: "Coffee Break", speaker: "", type: "break", description: "Morning refreshments and networking" },
      { time: "12:00 PM", title: "Cloud Infrastructure & Scalability", speaker: "Lisa Park", type: "presentation", description: "Building resilient cloud-first banking platforms" },
      { time: "12:45 PM", title: "Lunch & Partner Presentations", speaker: "", type: "networking", description: "Networking lunch with sponsor presentations" },
      { time: "2:15 PM", title: "Strategic Partnerships & Ecosystems", speaker: "Sophie Martin", type: "presentation", description: "Building collaborative fintech ecosystems" },
      { time: "3:00 PM", title: "Innovation Strategy & Culture", speaker: "Thomas Anderson", type: "presentation", description: "Fostering innovation within traditional banking" },
      { time: "3:45 PM", title: "Final Panel: Banking 2030 Vision", speaker: "All Keynote Speakers", type: "panel", description: "Looking ahead to the future of financial services" },
      { time: "4:30 PM", title: "Closing Remarks & Next Steps", speaker: "Event Organizers", type: "closing", description: "Event wrap-up and future initiatives" }
    ]
  };
  ...
  useEffect(() => {
    ...
    const itemObservers = itemRefs.current.slice(0, currentItems.length).map((item, index) => {
      if (!item) return null;
    ...
    >
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="text-center mb-12">
          ...
          >
            Two days packed with insights, networking, and innovation in financial services
          </p>
        </div>
          ...
          <div className="space-y-8">
            {scheduleData[activeDay].map((item, index) => (
              <div 
                ...
                style={{
                  transitionDelay: visibleItems.has(index) ? '0ms' : `${index * 60}ms`
                }}
              >
          ...
          <div className="bg-gradient-to-r from-purple-900 to-pink-900 rounded-xl p-6 md:p-8 mb-4 transform hover:scale-105 transition-all duration-300 hover:shadow-2xl hover:shadow-purple-500/25 group relative overflow-hidden">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 text-center relative z-10">
              <div className="group/item hover:scale-105 transition-transform duration-300 p-3 rounded-lg hover:bg-white/5">
                <div className="text-purple-300 font-semibold mb-1 group-hover/item:text-purple-200 transition-colors duration-300">📅 Dates</div>
                <div className="text-white group-hover/item:text-gray-100 transition-colors duration-300">March 15-16, 2024</div>
              </div>
              <div className="group/item hover:scale-105 transition-transform duration-300 p-3 rounded-lg hover:bg-white/5">
                <div className="text-purple-300 font-semibold mb-1 group-hover/item:text-purple-200 transition-colors duration-300">📍 Location</div>
                <div className="text-white group-hover/item:text-gray-100 transition-colors duration-300">Convention Center, Downtown</div>
              </div>
              <div className="group/item hover:scale-105 transition-transform duration-300 p-3 rounded-lg hover:bg-white/5">
                <div className="text-purple-300 font-semibold mb-1 group-hover/item:text-purple-200 transition-colors duration-300">⏰ Duration</div>
                <div className="text-white group-hover/item:text-gray-100 transition-colors duration-300">2 Full Days</div>
              </div>
            </div>
          </div>
