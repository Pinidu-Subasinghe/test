// src/components/EventOverview.jsx
  ...
  const animateNumber = (element, target, delay) => {
    setTimeout(() => {
      ...
      const timer = setInterval(() => {
        current += increment;
        if (current >= target) {
          element.textContent = target === 1000 ? '1000+' : target === 50 ? '50+' : target.toString();
          clearInterval(timer);
        } else {
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-2 lg:order-1">
            ...
            <div className="space-y-6 text-gray-300 leading-relaxed">
              ...
              >
                The banking industry stands at a pivotal moment. Digital transformation, 
                changing customer expectations, and emerging technologies are reshaping 
                the financial landscape at an unprecedented pace.
              </p>
              ...
              >
                This exclusive event brings together visionary leaders, innovative 
                technologists, and forward-thinking strategists to explore how 
                financial institutions can not just survive, but thrive in this 
                new era of banking.
              </p>
              ...
              >
                ...
                from regulatory compliance to sustainable finance, we'll dive deep 
                into the trends and technologies that are defining the future of 
                financial services.
              </p>
            </div>
            ...
            >
              <div className="text-center p-6 bg-gradient-to-br from-purple-900 to-purple-800 rounded-xl transform hover:scale-105 hover:shadow-2xl hover:shadow-purple-500/25 transition-all duration-300 group cursor-pointer">
                ...
                <div className="text-sm text-gray-300 group-hover:text-gray-200 transition-colors duration-300">Expert Speakers</div>
              ...
              <div className="text-center p-6 bg-gradient-to-br from-pink-900 to-pink-800 rounded-xl transform hover:scale-105 hover:shadow-2xl hover:shadow-pink-500/25 transition-all duration-300 group cursor-pointer delay-100">
                ...
                <div className="text-sm text-gray-300 group-hover:text-gray-200 transition-colors duration-300">Full Days</div>
              ...
              <div className="text-center p-6 bg-gradient-to-br from-blue-900 to-blue-800 rounded-xl transform hover:scale-105 hover:shadow-2xl hover:shadow-blue-500/25 transition-all duration-300 group cursor-pointer delay-200">
                ...
                <div className="text-sm text-gray-300 group-hover:text-gray-200 transition-colors duration-300">Attendees</div>
          ...
          <div className="order-1 lg:order-2">
            ...
            >
              ...
              <div 
                ...
                style={{
                  animation: isVisible ? 'float 6s ease-in-out infinite reverse' : 'none'
                }}
              >
                <div className="text-white font-semibold">Networking</div>
                <div className="text-blue-200 text-sm">Connect & Collaborate</div>
              </div>
            </div>
          </div>
        </div>
