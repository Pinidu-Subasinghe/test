...
const RegisterSection = () => {
  ...
  const ticketOptions = [
    {
      ...
      price: '$599',
      originalPrice: '$799',
      features: ['Access to all sessions', 'Networking events', 'Conference materials', 'Lunch and refreshments', 'Certificate of attendance'],
      popular: true,
      available: true,
    },
    {
    ...
    },
    {
      ...
      price: '$1299',
      originalPrice: null,
      features: ['Priority seating', 'VIP networking dinner', 'One-on-one speaker meetings', 'Premium conference kit', 'All standard features'],
      popular: false,
      available: true,
    },
    {
      ...
      price: '$299',
      originalPrice: null,
      features: ['Live stream access', 'Interactive Q&A', 'Digital materials', 'Recording access (30 days)', 'Virtual networking sessions'],
      popular: false,
      available: true,
    },
  ];
  ...
  // Individual ticket card observer
  useEffect(() => {
    ...
    return () => {
      ticketObservers.forEach(observer => observer?.disconnect());
    };
  }, []);
    ...
    >
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-12">
          ...
          >
            Secure your spot at the most important banking technology event of the year
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-4 mb-12">
          {ticketOptions.map((ticket, index) => (
            <div
              ...
              style={{
                transitionDelay: visibleTickets.has(index) ? '0ms' : `${index * 100}ms`
              }}
            >
              ...
              {ticket.popular && (
                <div 
                  className={`absolute -top-2 left-1/2 transform -translate-x-1/2 transition-all duration-500 delay-200 ${
                    visibleTickets.has(index) ? 'opacity-100 scale-100' : 'opacity-0 scale-75'
                  }`}
                >
              ...
              <ul className="text-xs text-gray-300 mb-2 space-y-1 relative z-10">
                {ticket.features.map((feature, idx) => (
                  ...
                  >
                    <span className="text-green-400 mr-1 transform group-hover:scale-110 transition-transform duration-300">✓</span>
                    {feature}
                  </li>
                ))}
              </ul>
        ...
        <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-xl p-6 md:p-8 relative overflow-hidden group">
          ...
          <h3 className="text-2xl font-bold mb-6 text-center relative z-10">Registration Details</h3>
          ...
          <div className="space-y-4 relative z-10">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-2 text-xs">
              {interestOptions.map((interest, index) => (
                <label key={index} className="flex items-center hover:text-purple-300 transition-colors duration-200 cursor-pointer">
                  <input
                    type="checkbox"
                    name="interests"
                    value={interest}
